...
! Constants modified for putative lunar atmosphere proposed by 
...
real, public, parameter :: RADIUS = 1737.0e3    ! Lunar radius 
real, public, parameter :: OMEGA  = 2.671e-6    ! Lunar angular rotation rate
real, public, parameter :: GRAV   = 1.625    
real, public, parameter :: RDGAS  = 125.3    ! Lunar specific gas constant based NK17
real, public, parameter :: KAPPA  = 2./7.  
real, public, parameter :: CP_AIR = RDGAS/KAPPA 
real, public, parameter :: CP_OCEAN = 840.0    ! Cp for basalt  https://www.engineeringtoolbox.com/specific-heat-solids-d_154.html
real, public, parameter :: RHO0    = 1.650e3   ! lunar surface from Lunar Sourcebook
